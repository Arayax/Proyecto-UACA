<%@ Page Title="Autenticación de dos factores" Language="vb" MasterPageFile="~/Site.Master" AutoEventWireup="false" CodeBehind="TwoFactorAuthenticationSignIn.aspx.vb" Inherits="Prestamos_Equipo_Computo_UACA.TwoFactorAuthenticationSignIn" %>
